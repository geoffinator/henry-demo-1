...
// Technicians
const TECHNICIANS = [
  { id:"henry", name:"Henry", license:"ON-4821", color: G.green },
  { id:"bruce", name:"Bruce", license:"ON-3190", color: G.blue },
  { id:"maria", name:"Maria", license:"ON-5512", color: "#7c3aed" },
];

const JOBS = [
  // J-1039: Completed + Paid (commercial, contract signed) — Maria
  {
    id:"J-1039", customerId:"c7", pestType:"Rodents", tech:"Maria", status:"Completed", urgency:"Normal",
    date:"2026-03-24", time:"9:00 AM", price:580, paid:true, paymentMethod:"Invoice (net 30)",
    ...
    conversation:[
      ...
      { from:"os",       time:"Mar 22, 11:00 AM", msg:"Hi there! Yes, commercial and multi-unit accounts are something we specialize in, with full documentation for every visit. To get started, could I get your name and the best email for sending confirmations?" },
      { from:"customer", time:"Mar 22, 11:08 AM", msg:"Sure — name is Marcus Webb, ops@haltonpm.ca" },
      { from:"os",       time:"Mar 22, 11:09 AM", msg:"Perfect, thanks Marcus. And the property address — or if it's multiple units, a primary contact address works fine." },
      { from:"customer", time:"Mar 22, 11:15 AM", msg:"Multiple units across Mississauga. Main office is at 880 Pacific Rd, Oakville." },
      { from:"os",       time:"Mar 22, 11:16 AM", msg:"Got it. I'd like to get Maria out for an initial walkthrough of your Mississauga properties and we can set up a monthly program from there. What works best for your schedule this week?" },
      { from:"customer", time:"Mar 22, 1:30 PM",  msg:"Tuesday March 24 morning works. Can you do 9am?" },
      { from:"os",       time:"Mar 22, 1:31 PM",  msg:"Perfect — Maria is confirmed for Tuesday March 24 at 9:00 AM. Confirmation sent to ops@haltonpm.ca. Looking forward to getting your properties sorted." },
      { from:"os",       time:"Mar 24, 8:00 AM",  msg:"Good morning Marcus — Maria is on her way to your Mississauga properties. ETA 9:00 AM." },
      { from:"os",       time:"Mar 24, 11:45 AM", msg:"Maria has completed the 3-unit inspection. Invoice #1039 for $580.00 (net 30) has been sent to ops@haltonpm.ca. A monthly prevention contract proposal is attached." },
    ],
    timeline:[
      { time:"Mar 22, 11:00 AM", event:"Lead received",        detail:"Inbound email — commercial multi-unit inquiry", type:"lead" },
      { time:"Mar 22, 11:00 AM", event:"OS responded",         detail:"Intake sequence started — collecting contact info", type:"os" },
      { time:"Mar 22, 11:16 AM", event:"Info collected",       detail:"Name, email, address gathered — booking initiated", type:"os" },
      { time:"Mar 22, 1:31 PM",  event:"Job booked",           detail:"Maria assigned, Mar 24 9:00 AM confirmed", type:"booked" },
      { time:"Mar 22, 1:31 PM",  event:"Confirmation sent",    detail:"Booking confirmation sent to ops@haltonpm.ca", type:"comms" },
      ...
      { time:"Mar 24, 11:30 AM", event:"Invoice sent",         detail:"Invoice #1039 — $580.00 net 30", type:"invoice" },
  ...
  // J-1040: Completed + Paid (routine) — Bruce
  {
    ...
    conversation:[
      { from:"customer", time:"Mar 19, 9:00 AM", msg:"Hi, we've been seeing cockroaches in our kitchen for about a week now. A few in the mornings." },
      { from:"os",       time:"Mar 19, 9:00 AM", msg:"Hi there! A week of cockroach sightings means it's time to act before they settle in. Can I start with your name and address so I can get someone scheduled for you?" },
      { from:"customer", time:"Mar 19, 9:04 AM", msg:"Stephanie Noel. 5 Glenwood Ave, East York." },
      { from:"os",       time:"Mar 19, 9:05 AM", msg:"Thanks Stephanie! And a phone number and email for your confirmation?" },
      { from:"customer", time:"Mar 19, 9:08 AM", msg:"416-778-4423 and snoel@live.ca" },
      { from:"os",       time:"Mar 19, 9:09 AM", msg:"Perfect — Bruce can come out to your East York home this week. Are you available Thursday or Friday afternoon?" },
      ...
      { from:"os",       time:"Mar 24, 6:00 PM", msg:"Just a reminder that Bruce is coming to your East York home tomorrow (Tuesday) at 1:00 PM. No prep needed on your end." },
      { from:"os",       time:"Mar 25, 12:30 PM",msg:"Bruce is about 30 minutes away. See you shortly!" },
      { from:"os",       time:"Mar 25, 3:00 PM", msg:"Bruce has completed your cockroach treatment. Invoice #1040 for $160.00 has been sent. How was the service? A quick Google review would mean a lot to us!" },
    ],
    timeline:[
      { time:"Mar 19, 9:00 AM", event:"Lead received",         detail:"Inbound web form", type:"lead" },
      { time:"Mar 19, 9:00 AM", event:"OS intake started",     detail:"Collecting name, address, contact info", type:"os" },
      { time:"Mar 19, 9:09 AM", event:"Info collected",        detail:"All details gathered — booking initiated", type:"os" },
  ...
  // J-1041: Overdue invoice — Bruce
  {
    ...
    conversation:[
      { from:"customer", time:"Mar 17, 7:30 PM", msg:"Hi, I've been hearing scratching in my walls at night and found some droppings in my pantry. I think I might have mice." },
      { from:"os",       time:"Mar 17, 7:30 PM", msg:"Hi! Scratching in walls and droppings are classic signs of mice — the good news is this is very treatable. To get you booked in, can I get your full name and address?" },
      { from:"customer", time:"Mar 17, 7:38 PM", msg:"Linda Tremblay. 19 Elmwood Cres, North York." },
      { from:"os",       time:"Mar 17, 7:39 PM", msg:"Thanks Linda! And a phone number and email for your booking confirmation?" },
      { from:"customer", time:"Mar 17, 7:44 PM", msg:"905-443-8812. ltremblay@hotmail.com" },
      { from:"os",       time:"Mar 17, 7:45 PM", msg:"Perfect. We can get Bruce out to your North York home this week. Does Monday or Tuesday work for you?" },
      { from:"customer", time:"Mar 17, 7:46 PM", msg:"Monday works!" },
      { from:"os",       time:"Mar 17, 7:47 PM", msg:"Bruce is confirmed for Monday March 19 at 11:00 AM. Confirmation sent to ltremblay@hotmail.com. See you Monday!" },
      { from:"os",       time:"Mar 18, 6:00 PM", msg:"Just a reminder that Bruce is coming tomorrow (Monday) at 11:00 AM." },
      ...
      { from:"os",       time:"Mar 26, 9:00 AM", msg:"Hi Linda — just a friendly reminder that invoice #1041 for $185.00 is now due. You can pay online using the link in your original invoice email." },
    ...
    timeline:[
      ...
      { time:"Mar 17, 7:30 PM",  event:"OS intake started",    detail:"Collecting name, address, contact info", type:"os" },
      { time:"Mar 17, 7:47 PM",  event:"Job booked",           detail:"Bruce assigned, Mar 19 11:00 AM confirmed", type:"booked" },
    ...
    complianceRecord:{ date:"2026-03-19", tech:"Bruce", license:"ON-3190", pest:"Mice", product:"Contrac Blox", units:"1", area:"Kitchen walls, pantry area", notes:"Bait stations placed at 4 locations. Entry point at utility gap behind stove — sealed." }
  },

  // J-1042: Completed + Paid (emergency) — Henry
  {
    ...
    conversation:[
      ...
      { from:"os",       time:"Mar 25, 8:14 PM", msg:"Hi — I completely understand, and with a newborn at home this is our absolute top priority. We'll treat this as an emergency booking. Can you confirm your full name and address so I can dispatch Henry first thing tomorrow morning?" },
      { from:"customer", time:"Mar 25, 8:18 PM", msg:"Sandra Okafor. 44 Birchwood Ave Scarborough." },
      { from:"os",       time:"Mar 25, 8:19 PM", msg:"Thank you Sandra. And the best number and email to send your confirmation to?" },
      { from:"customer", time:"Mar 25, 8:21 PM", msg:"647-882-3341. sandra.okafor@gmail.com" },
      { from:"os",       time:"Mar 25, 8:22 PM", msg:"Confirmed — Henry will be at 44 Birchwood Ave tomorrow at 9:00 AM sharp. Emergency booking confirmed. You'll get a confirmation now and a reminder in the morning. In the meantime, keep food sealed and avoid disturbing droppings. See you tomorrow." },
      { from:"os",       time:"Mar 26, 8:00 AM", msg:"Good morning Sandra — Henry is on his way. ETA 9:00 AM." },
      { from:"os",       time:"Mar 26, 11:00 AM",msg:"Henry has completed your mice treatment. Entry point behind the fridge has been sealed and bait stations placed. Invoice #1042 for $210.00 has been sent. Your home is safe." },
    ],
    timeline:[
      { time:"Mar 25, 8:14 PM", event:"Lead received",         detail:"Emergency inbound — web form", type:"lead" },
      { time:"Mar 25, 8:14 PM", event:"OS intake started",     detail:"Emergency response — collecting address + contact", type:"os" },
      { time:"Mar 25, 8:22 PM", event:"Emergency job booked",  detail:"Henry assigned, Mar 26 9:00 AM — same-day priority", type:"booked" },
    ...
    complianceRecord:{ date:"2026-03-26", tech:"Henry", license:"ON-4821", pest:"Mice", product:"Contrac Blox", units:"1", area:"Kitchen — behind fridge, utility gap", notes:"Entry point sealed. 3 bait stations placed. Emergency booking — newborn in home." }
  },
  ...
  // J-1043: Booked (upcoming) — Bruce
  {
    ...
    conversation:[
      { from:"customer", time:"Mar 27, 11:02 AM", msg:"Hey do you guys deal with cockroaches? Found a couple in my bathroom over the last few days. Not an emergency but want to get it sorted." },
      { from:"os",       time:"Mar 27, 11:02 AM", msg:"Hey! Yes, cockroaches in the bathroom is something we handle all the time — and the sooner the better. To get you booked, can I grab your name and address?" },
      { from:"customer", time:"Mar 27, 11:07 AM", msg:"David Park. 312 Royal York Rd Unit 4B, Etobicoke." },
      { from:"os",       time:"Mar 27, 11:08 AM", msg:"Thanks David. And your phone number and email for the confirmation?" },
      { from:"customer", time:"Mar 27, 11:11 AM", msg:"416-554-7821. dpark@outlook.com" },
      { from:"os",       time:"Mar 27, 11:12 AM", msg:"Perfect. We can get Bruce out to your Etobicoke unit Monday afternoon. Does 2:00 PM work for you?" },
      ...
      { from:"os",       time:"Mar 30, 6:00 PM",  msg:"Just a reminder that Bruce is coming tomorrow (Monday) at 2:00 PM. Nothing special needed on your end." },
    ],
    timeline:[
      { time:"Mar 27, 11:02 AM", event:"Lead received",        detail:"Inbound web form", type:"lead" },
      { time:"Mar 27, 11:02 AM", event:"OS intake started",    detail:"Collecting name, address, contact info", type:"os" },
      { time:"Mar 27, 11:12 AM", event:"Info collected",       detail:"All details gathered — booking initiated", type:"os" },
  ...
  // J-1044: In Progress (commercial) — Henry
  {
    ...
    conversation:[
      ...
      { from:"os",       time:"Mar 26, 3:45 PM", msg:"Hello! Commercial kitchens and health inspection documentation are something we specialize in. To get started, can I get your name and the restaurant's address?" },
      { from:"customer", time:"Mar 26, 3:52 PM", msg:"Marcus Webb. Parkway Grill, 88 King St W Toronto." },
      { from:"os",       time:"Mar 26, 3:53 PM", msg:"Thanks Marcus. And the best phone and email to reach you?" },
      { from:"customer", time:"Mar 26, 3:58 PM", msg:"416-901-2234. marcus@parkwaygrill.ca" },
      { from:"os",       time:"Mar 26, 3:59 PM", msg:"Great — I'd like to get Henry out for an initial assessment and we can set up a monthly prevention program from there. What works Tuesday or Wednesday morning?" },
      { from:"customer", time:"Mar 26, 4:10 PM", msg:"Saturday March 30 works better for us. 10am?" },
      { from:"os",       time:"Mar 26, 4:11 PM", msg:"Absolutely — Henry is confirmed for Saturday March 30 at 10:00 AM. Confirmation sent to marcus@parkwaygrill.ca." },
    ...
    timeline:[
      ...
      { time:"Mar 26, 3:45 PM", event:"OS intake started",     detail:"Collecting name, address, contact info", type:"os" },
      { time:"Mar 26, 3:59 PM", event:"Info collected",        detail:"All details gathered — booking initiated", type:"os" },
  ...
  // J-1045: New Lead — Bed Bugs — Henry (address not yet collected)
  {
    ...
    notes:"Suspected bed bugs, woke up with bites. Condo on Sheppard. OS has collected name and email but still needs phone and unit number. Follow-up scheduled.",
    ...
    conversation:[
      ...
      { from:"os",       time:"Mar 28, 7:18 AM", msg:"Hi — bed bugs can be really stressful and I want to get someone to you quickly. First, can I get your name and email so I can send you a confirmation once we get this booked?" },
      { from:"customer", time:"Mar 28, 7:24 AM", msg:"Raymond Xu. raymond.xu@gmail.com" },
      { from:"os",       time:"Mar 28, 7:25 AM", msg:"Thanks Raymond. And the full address including your unit number on Sheppard?" },
      { from:"os",       time:"Mar 29, 9:00 AM", msg:"Hi Raymond — just following up. Still need your unit number and a phone number so we can confirm Henry's visit. Bed bugs are time-sensitive — the sooner we get in, the better." },
    ],
    timeline:[
      { time:"Mar 28, 7:18 AM", event:"Lead received",         detail:"Inbound web form — bed bugs", type:"lead" },
      { time:"Mar 28, 7:18 AM", event:"OS intake started",     detail:"Collecting name and contact info", type:"os" },
      { time:"Mar 28, 7:25 AM", event:"Partial info collected",detail:"Name + email gathered. Awaiting address + phone.", type:"os" },
      { time:"Mar 29, 9:00 AM", event:"Follow-up sent",        detail:"Automated 24h follow-up — awaiting address + phone", type:"comms" },
    ],
  },

  // J-1046: No Response — cold lead — (no tech assigned)
  {
    ...
    conversation:[
      ...
      { from:"os",       time:"Mar 23, 2:00 PM", msg:"Hi! Wasp nest removal under a deck is a standard job for us — typically $130–160 depending on nest size. To get you a firm quote and schedule someone, can I get your name and address?" },
      { from:"os",       time:"Mar 25, 9:00 AM", msg:"Hi — just following up on your wasp nest inquiry. We have availability this week. Could I grab your name and address to get something booked?" },
    ...
    timeline:[
      ...
      { time:"Mar 23, 2:00 PM", event:"OS responded",           detail:"Quote provided, intake sequence started", type:"os" },
  ...
  // J-1047: Technician no-show — Bruce
  {
    ...
    conversation:[
      { from:"customer", time:"Mar 26, 10:15 AM", msg:"Hi, I have a bad ant problem in my kitchen and bathroom. Can you help?" },
      { from:"os",       time:"Mar 26, 10:15 AM", msg:"Hi! Ant problems in the kitchen and bathroom are very common this time of year and totally fixable. To get you scheduled, can I get your name and address?" },
      { from:"customer", time:"Mar 26, 10:19 AM", msg:"Aisha Mensah. 55 Dufferin St, Toronto." },
      { from:"os",       time:"Mar 26, 10:20 AM", msg:"Thanks Aisha! And your phone number and email for the confirmation?" },
      { from:"customer", time:"Mar 26, 10:23 AM", msg:"647-554-2210. aisha.mensah@hotmail.com" },
      { from:"os",       time:"Mar 26, 10:24 AM", msg:"Perfect — Bruce can come out Sunday morning. Does 11:00 AM work for you?" },
    ...
    timeline:[
      ...
      { time:"Mar 26, 10:15 AM", event:"OS intake started",          detail:"Collecting name, address, contact info", type:"os" },
  ...
  // J-1048: Cancelled job — Henry
  {
    ...
    notes:"Customer cancelled morning of job — said they handled it themselves with traps.",
    conversation:[
      ...
      { from:"os",       time:"Mar 24, 3:00 PM",  msg:"Hi — completely understand, a daycare environment makes this a top priority. Can I get your name and the daycare's address to get Henry scheduled right away?" },
      { from:"customer", time:"Mar 24, 3:06 PM",  msg:"My name is Priya Sharma, admin@sunrisedaycare.ca. 12 Sunrise Blvd, Brampton." },
      { from:"os",       time:"Mar 24, 3:07 PM",  msg:"Thanks Priya. And the best phone number for day-of contact?" },
      { from:"customer", time:"Mar 24, 3:10 PM",  msg:"905-664-9981" },
      { from:"os",       time:"Mar 24, 3:11 PM",  msg:"Henry is confirmed for Thursday March 27 at 2:00 PM at 12 Sunrise Blvd, Brampton. Confirmation sent to admin@sunrisedaycare.ca." },
      ...
      { from:"os",       time:"Mar 27, 9:01 AM",  msg:"No problem — I've cancelled your appointment for today. If the problem returns, don't hesitate to reach out and we'll get Henry out quickly. Mice are persistent so keep an eye out over the next week." },
    ],
    timeline:[
      { time:"Mar 24, 3:00 PM",  event:"Lead received",        detail:"Inbound email — daycare commercial", type:"lead" },
      { time:"Mar 24, 3:00 PM",  event:"OS intake started",    detail:"Collecting name, address, contact info", type:"os" },
      { time:"Mar 24, 3:11 PM",  event:"Job booked",           detail:"Henry assigned, Mar 27 2:00 PM", type:"booked" },
  ...
  // J-1049: Vague inquiry / repeat customer / upsell — (no tech yet)
  {
    ...
    conversation:[
      ...
      { from:"os",       time:"Mar 30, 8:30 AM", msg:"Hi Linda! Happy to help figure this out. Where in the house are you noticing them, and what do they look like — tiny black dots, larger beetles, something flying?" },
      { from:"customer", time:"Mar 30, 8:45 AM", msg:"I see little things near my window. Kind of small and black." },
      { from:"os",       time:"Mar 30, 8:46 AM", msg:"That sounds like it could be carpet beetles or fungus gnats — both very treatable. Is it near a plant or a window with soil nearby? Also — since you had mice treated last month, a prevention check-in from Bruce might be a good idea too. We offer a quarterly prevention package that covers rodents and common insects — want me to tell you more?" },
    ],
    timeline:[
...
// Computed from JOBS data — single source of truth
...
// ─── TECH DASHBOARD ───────────────────────────────────────────────────────────
function TechDashboard({ setActive, setSelectedJob, osMessages }) {
  const myJobs = JOBS.filter(j => j.tech==="Henry" && j.date==="2026-03-30");
  const techMessages = osMessages.filter(m => m.for==="tech" && !m.resolved);
  const allMyJobs = JOBS.filter(j => j.tech==="Henry");
...
Business: Henry the Exterminator | GTA | Services: Rodents, Cockroaches, Bed Bugs, Ants, Wasps, Wildlife | Technicians: Henry, Bruce, Maria | Pricing: $130–$160 wasps/ants, $150–$250 mice/cockroaches standard, $300–$450 bed bugs | Payment: Credit card or net 30 invoice (commercial) | Ontario Pesticides Act certified.

INTAKE SEQUENCE — critical to follow:
1. Read the customer message carefully. Extract any information already provided (name, address, phone, email, pest type, urgency).
2. Identify what is still MISSING from: full name, service address, phone number, email address.
3. If information is missing, ask for it — but ask for AT MOST 2 missing pieces at once. Do not book without name + address minimum.
4. Once you have name + address + contact (phone or email), you can book and assign a technician.
5. For emergencies, prioritize speed — collect name + address first, get contact details after.
...
When a customer message comes in, respond with ONLY valid JSON (no markdown, no preamble):
{
  ...
  "technician": "Henry or Bruce or Maria (only assign if intakeComplete is true)",
  "estimatedPrice": "$XXX–$XXX",
  "outboundMessage": "Warm, professional reply. Sound like a real local business. If intake is incomplete, ask for the next 1-2 missing pieces naturally. If intake is complete, confirm the booking with all details. Never ask for more than 2 things at once.",
  "routing": "Awaiting info / Schedule with Henry / Schedule with Bruce / Schedule with Maria / Emergency escalation",
  "bookingConfirmed": true or false
}`;

const DEMO_SCENARIOS = [
  { label:"🚨 Emergency — no info", msg:"Hi I found mice droppings all over my kitchen this morning and I have a newborn at home. This is a serious health issue, I need someone TODAY." },
  { label:"🪳 Has address only", msg:"Hey do you guys deal with cockroaches? Found a couple in my bathroom over the last few days. Not an emergency but want to get it sorted. Located in Etobicoke, unit 4B at 312 Royal York Rd." },
  { label:"🏢 Commercial — full info", msg:"Hello, I manage Parkway Grill at 88 King St W Toronto. I'm Marcus Webb, 416-901-2234, marcus@parkwaygrill.ca. We've been seeing rodent activity near our storage. Need someone who keeps documentation for health inspections." },
  { label:"❓ Vague — no info", msg:"Hi I have a bug problem" },
  { label:"🛏 Bed bugs — partial", msg:"I woke up with bites and I think it might be bed bugs. I'm Raymond Xu at 77 Sheppard Ave E #902 Toronto. raymond.xu@gmail.com" },
  { label:"🐜 Ants — gives all info", msg:"Hi I'm Aisha Mensah, 647-554-2210, aisha.mensah@hotmail.com. I have a bad ant problem at 55 Dufferin St Toronto. Can someone come this weekend?" },
];
...
function D1LeadMgmt({ selectedJob, setSelectedJob }) {
  ...
  const steps = ["Parsing message","Extracting provided info","Identifying missing fields","Assessing urgency","Composing response","Routing","Logging"];
  ...
  return (
    <div>
      ...
      <div style={{ fontSize:13, fontWeight:600, color:G.textMuted, marginBottom:10, letterSpacing:"0.03em" }}>LIVE LEAD INBOX — OS RESPONDS WITH INTAKE SEQUENCING</div>
            ...
            <div>
              ...
              <Card style={{ marginBottom:12 }}>
                ...
                {[
                  ...
                  ["Phone",result.phone],
                  ["Email",result.email],
                  ["Pest type",result.pestType],
                  ["Job type",result.jobType],
                  ["Urgency",result.urgency],
                  ["Assigned to",result.intakeComplete?result.technician:"Pending intake"],
                  ["Estimate",result.estimatedPrice],
                  ["Routing",result.routing],
                ].map(([k,v])=>{
                  const isRequested = v==="Requested" || v==="Pending intake";
                  return (
                    <div key={k} style={{ display:"flex", justifyContent:"space-between", padding:"5px 0", borderBottom:`1px solid ${G.border}`, fontSize:12 }}>
                      ...
                      <span style={{ color:isRequested?G.amber:G.text, fontWeight:500, fontStyle:isRequested?"italic":"normal" }}>{v||"—"}</span>
                    </div>
                  );
                })}
              ...
              <div style={{ padding:"10px 14px", background:result.bookingConfirmed?G.greenLight:G.amberLight, borderRadius:8, fontSize:12, color:result.bookingConfirmed?G.green:G.amber, fontWeight:500 }}>
                {result.bookingConfirmed ? "✓ Intake complete · Technician assigned · Booking confirmed · 0 human steps" : "⏳ Intake sequence active — OS will continue collecting info until booking is ready"}
              </div>
            </div>
          )}
        </div>
        ...
        <Card>
          ...
          <div style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
            ...
            <div>
              ...
              <div style={{ fontSize:12, color:job.addressCollected===false?G.amber:G.textMuted, marginTop:3, fontStyle:job.addressCollected===false?"italic":"normal" }}>
                {addrDisplay}
              </div>
            </div>
          </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            {job.conversation.map((m,i)=>(
              <div key={i} style={{ display:"flex", flexDirection:"column", alignItems:m.from==="customer"?"flex-start":"flex-end" }}>
                ...
                <div style={{ maxWidth:"80%", padding:"10px 14px", borderRadius:12, fontSize:13, lineHeight:1.6, color:m.from==="os"?"#fff":G.text, background:m.from==="os"?G.green:m.msg.includes("⚠️")?G.redLight:G.bg, border:m.from==="customer"?`1px solid ${G.border}`:"none" }}>
                  {m.msg}
                </div>
              </div>
            ))}
...
function D2Calendar({ role }) {
  const techFilter = role === "tech" ? "Henry" : null;
  ...
  const techColors = { "Henry":G.green, "Bruce":G.blue, "Maria":"#7c3aed" };

  return (
    <div>
      <SectionHeader title={role==="tech"?"D2 — My Schedule":"D2 — Scheduling & Dispatch"} sub={`Week of March 24–30, 2026${role==="tech"?" · Henry's jobs only":""}`} />
            ...
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", cursor:"pointer" }} onClick={()=>setExpandedJob(isExpanded?null:job.id)}>
              <div>
                <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:4 }}>
                  ...
                  <StatusBadge status={job.status} />
                  {job.paid && <span style={{ fontSize:11, padding:"2px 8px", borderRadius:10, background:G.greenLight, color:G.green, fontWeight:600 }}>✓ Paid</span>}
                  {!job.paid && job.price > 0 && <span style={{ fontSize:11, padding:"2px 8px", borderRadius:10, background:G.redLight, color:G.red, fontWeight:600 }}>⚠️ Unpaid</span>}
                </div>
              ...
              <div style={{ marginTop:16, borderTop:`1px solid ${G.border}`, paddingTop:16 }}>
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:14, marginBottom:16 }}>
                  ...
                  <div style={{ padding:"12px 14px", background:G.bg, borderRadius:10 }}>
                    ...
                    {[["Tech",job.tech],["Date",job.date],["Time",job.time],["Pest",job.pestType],["Payment",job.paymentMethod||"—"],["Invoice status",job.paid?"Paid ✓":"Unpaid ⚠️"]].map(([k,v])=>(
                    ...
                    <div style={{ maxHeight:200, overflowY:"auto", display:"flex", flexDirection:"column", gap:8 }}>
                      {job.conversation.slice(-4).map((m,i)=>(
                        <div key={i} style={{ display:"flex", flexDirection:"column", alignItems:m.from==="customer"?"flex-start":"flex-end" }}>
                          ...
                          <div style={{ maxWidth:"85%", padding:"8px 12px", borderRadius:10, fontSize:12, lineHeight:1.5, color:m.from==="os"?"#fff":G.text, background:m.from==="os"?G.green:G.bg, border:m.from==="customer"?`1px solid ${G.border}`:"none" }}>
                            {m.msg}
                          </div>
                        </div>
                      ))}
                ...
                {job.notes && (
                  <div style={{ padding:"10px 12px", background:G.amberLight, borderRadius:8, fontSize:12, color:G.amber, fontStyle:"italic" }}>{job.notes}</div>
                )}
              </div>
            )}
          </Card>
  ...
  return (
    <div>
      ...
      {invoiceJobs.map(job=>{
        ...
        const daysOut = job.status==="Overdue"?9:job.paid?0:job.date==="2026-03-26"?4:3;
          ...
          <Card key={job.id} style={{ marginBottom:12, borderLeft:job.status==="Overdue"?`4px solid ${G.red}`:job.paid?`4px solid ${G.green}`:`4px solid ${G.amberMid}`, cursor:"pointer" }} onClick={()=>setExpandedInvoice(isExpanded?null:job.id)}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
              <div>
                ...
                <div style={{ fontSize:12, color:G.textMuted, marginTop:2 }}>{job.pestType} · {job.date} · {job.paymentMethod||"Credit card"} · Tech: {job.tech||"—"}</div>
              </div>
              <div style={{ textAlign:"right" }}>
              ...
              <div style={{ marginTop:16, borderTop:`1px solid ${G.border}`, paddingTop:16 }} onClick={e=>e.stopPropagation()}>
                ...
                <div style={{ display:"flex", justifyContent:"space-between", marginBottom:16 }}>
                  <div>
                    ...
                    <div style={{ fontSize:12, color:G.textMuted }}>Greater Toronto Area · ON Pesticides Lic. ON-4821</div>
                  ...
                  <div style={{ textAlign:"right" }}>
                    ...
                    <div style={{ fontSize:12, color:G.textMuted }}>Due: {job.paymentMethod?.includes("net 30")?"Net 30":"On receipt"}</div>
                  </div>
                </div>
                ...
                <table style={{ width:"100%", borderCollapse:"collapse", marginBottom:14 }}>
                  ...
                  <tbody>
                    <tr style={{ borderBottom:`1px solid ${G.border}` }}>
                      ...
                      <td style={{ padding:"10px 12px", fontSize:13, color:G.text }}>{money(job.price * 0.85)}</td>
                      <td style={{ padding:"10px 12px", fontSize:13, fontWeight:600, color:G.text }}>{money(job.price * 0.85)}</td>
                    </tr>
                    <tr style={{ borderBottom:`1px solid ${G.border}` }}>
                      <td style={{ padding:"10px 12px", fontSize:13, color:G.text }}>Materials & product application</td>
                      <td style={{ padding:"10px 12px", fontSize:13, color:G.text }}>1</td>
                      <td style={{ padding:"10px 12px", fontSize:13, color:G.text }}>{money(job.price * 0.15)}</td>
                      <td style={{ padding:"10px 12px", fontSize:13, fontWeight:600, color:G.text }}>{money(job.price * 0.15)}</td>
                    </tr>
                ...
                {!job.paid && (
                  <div style={{ padding:"10px 14px", background:job.status==="Overdue"?G.redLight:G.amberLight, borderRadius:8, fontSize:12, color:job.status==="Overdue"?G.red:G.amber }}>
                    {job.status==="Overdue"?"⚠️ 2 automated follow-ups sent. Direct call recommended to " + c?.phone + ".":"⏰ Automated follow-up scheduled at 7 days if unpaid."}
                  </div>
                )}
              </div>
            )}
...
// ─── OS CHAT (Two-way Human ↔ OS) ────────────────────────────────────────────
const OS_CHAT_SYSTEM = `You are the operating system (OS) for Henry the Exterminator, a pest control company in the Greater Toronto Area. You are having a direct conversation with the business owner (Henry) or technician.

You have full awareness of the current jobs:
- J-1039: Halton Property Mgmt — Maria completed. Paid $580.
- J-1040: Stephanie Noel — Bruce completed cockroaches. Paid $160.
- J-1041: Linda Tremblay — overdue invoice $185. 9 days unpaid.
- J-1042: Sandra Okafor — emergency mice, Henry completed. Paid $210.
- J-1043: David Park — Bruce booked for cockroaches Mar 31.
- J-1044: Parkway Grill (Marcus Webb) — Henry in progress now, rodents.
- J-1045: Raymond Xu — bed bug lead, awaiting address/phone.
- J-1046: James Kowalski — cold wasp lead, no response 5 days.
- J-1047: Aisha Mensah — Bruce no-show, ants. URGENT. Customer waiting.
- J-1048: Sunrise Daycare — cancelled by customer.
- J-1049: Linda Tremblay — vague bug inquiry, qualifying.

When the human gives you an instruction, acknowledge it and tell them what action you are taking. Be specific about which job and what you will do. If they ask you to follow up with a cold lead, send a message to that customer. If they tell you to reschedule something, confirm it. Be concise, professional, and action-oriented. Always confirm what you did.

Respond with ONLY valid JSON:
{
  "osReply": "Your response to the human — what you heard, what action you're taking",
  "actionTaken": "Brief description of the specific action the OS executed (e.g., 'Sent follow-up text to James Kowalski', 'Rescheduled J-1047 to Tuesday April 1 at 10am', 'Sent payment reminder to Linda Tremblay')",
  "affectedJob": "Job ID if applicable, or null",
  "affectedCustomer": "Customer name if applicable, or null"
}`;

function Messages({ role, osMessages, setOsMessages }) {
  ...
  const [chatMessages, setChatMessages] = useState([
    { from:"os", text: role==="owner" ? "Hi Henry — I'm monitoring everything. What do you need?" : "Hi Henry — what do you need from me?", time:"Now" }
  ]);
  ...
  const sendToOS = async () => {
    ...
    setChatInput("");
    const newHistory = [...chatMessages, { from:"human", text:userMsg, time:"Now" }];
    ...
    try {
      ...
      setChatMessages(prev => [...prev, { from:"os", text:parsed.osReply, action:parsed.actionTaken, affectedJob:parsed.affectedJob, affectedCustomer:parsed.affectedCustomer, time:"Now" }]);
    } catch(e) {
      setChatMessages(prev => [...prev, { from:"os", text:"Something went wrong processing that. Try again.", time:"Now" }]);
    }
      ...
      <div style={{ marginTop:24 }}>
        ...
        <Card style={{ padding:0, overflow:"hidden" }}>
          <div style={{ padding:"12px 16px", background:G.greenLight, borderBottom:`1px solid ${G.border}` }}>
            ...
            <div style={{ fontSize:11, color:G.green, opacity:0.8 }}>Type a task or instruction — the OS will act on it immediately</div>
          </div>
          <div style={{ height:320, overflowY:"auto", padding:"16px", display:"flex", flexDirection:"column", gap:10 }}>
            {chatMessages.map((m,i)=>(
              <div key={i} style={{ display:"flex", flexDirection:"column", alignItems:m.from==="human"?"flex-end":"flex-start" }}>
                <div style={{ fontSize:10, color:G.textLight, marginBottom:3 }}>{m.from==="human"?(role==="owner"?"Henry (Owner)":"Henry (Tech)"):"OS"}</div>
                <div style={{ maxWidth:"80%", padding:"10px 14px", borderRadius:12, fontSize:13, lineHeight:1.6, background:m.from==="human"?G.blue:G.green, color:"#fff" }}>
                  {m.text}
                </div>
                {m.action && (
                  <div style={{ maxWidth:"80%", marginTop:4, padding:"6px 12px", borderRadius:8, fontSize:11, background:G.greenLight, color:G.green, fontWeight:500 }}>
                    ✓ Action taken: {m.action}{m.affectedCustomer?` · ${m.affectedCustomer}`:""}
                  </div>
                )}
              </div>
            ))}
          ...
          <div style={{ padding:"12px 16px", borderTop:`1px solid ${G.border}`, display:"flex", gap:10 }}>
            <input
              ...
              onKeyDown={e=>e.key==="Enter"&&sendToOS()}
              placeholder="e.g. 'Try James Kowalski one more time' or 'Reschedule Aisha to Tuesday 10am'..."
            ...
            />
            <button onClick={sendToOS} disabled={chatLoading||!chatInput.trim()} style={{ padding:"10px 20px", borderRadius:8, border:"none", background:chatLoading||!chatInput.trim()?G.border:G.green, color:"#fff", fontSize:13, fontWeight:600, cursor:chatLoading||!chatInput.trim()?"not-allowed":"pointer", fontFamily:"inherit" }}>
              Send
            </button>
          </div>
        </Card>
        <div style={{ marginTop:8, fontSize:11, color:G.textLight }}>Try: "Follow up with James Kowalski one more time" · "Reschedule Aisha to Tuesday at 10am" · "Call Linda about the overdue invoice" · "Update me on Parkway Grill"</div>
      </div>
    </div>
  );
}
...
function WeeklySummary() {
  ...
  // Technician breakdown — from actual job data
    ...
    <div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:18, marginBottom:18 }}>
        ...
        <Card>
          ...
          <div style={{ marginTop:10, padding:"10px 12px", background:G.bg, borderRadius:8, fontSize:12, color:G.textMuted }}>
            ...
            <div>· {JOBS.filter(j=>j.humanFlag).length} edge cases flagged to owner for human action</div>
      ...
      <Card style={{ borderLeft:`3px solid ${G.amber}` }}>
        ...
        <div style={{ display:"flex", gap:10, flexDirection:"column" }}>
          ...
          <div style={{ fontSize:13, color:G.text }}>🛏 <strong>J-1045</strong> (Raymond Xu — bed bugs) — Lead awaiting address & phone. High urgency. Follow up today.</div>
          <div style={{ fontSize:13, color:G.text }}>🤝 <strong>Parkway Grill</strong> — Monthly contract opportunity. Henry on site now — follow up this afternoon.</div>
        </div>
        <div style={{ marginTop:12, fontSize:12, color:G.textLight, fontStyle:"italic" }}>
          Everything else this week ran automatically. These are the only items that need a human.
        </div>
      </Card>
    </div>
  );
...
export default function App() {
  ...
  const [osMessages, setOsMessages] = useState(INITIAL_OS_MESSAGES);
  ...
  const renderPanel = () => {
    ...
    switch(active) {
      ...
      case "techdash":  return <TechDashboard  setActive={handleSetActive} setSelectedJob={setSelectedJob} osMessages={osMessages} />;
      ...
      case "messages":  return <Messages role={role} osMessages={osMessages} setOsMessages={setOsMessages} />;
